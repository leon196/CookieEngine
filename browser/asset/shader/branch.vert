...
uniform float branchCount, branchSegments, branchCountDimension, thin;
...
void main () {
	...
	vec3 next = texture2D(branchTexture, indexNext).xyz;
	vec3 prev = texture2D(branchTexture, indexPrev).xyz;
